...
import { getGoogleRedirectUri, validateGoogleOAuthState } from './google-oauth';

export const GoogleCallback = () => {
  const router = useRouter();
  const searchParams = useSearchParams();
  const { authenticateWithGoogle } = useAuthSession();
  ...
  }, [authenticateWithGoogle, router, searchParams]);
